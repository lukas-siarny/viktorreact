...
describe('Specialit contacts', () => {
	...
	it('Create specialist contact', () => {
		...
		cy.setInputValue(FORM.SPECIALIST_CONTACT, 'countryCode', specialistContact.create.countryCode)
		cy.setInputValue(FORM.SPECIALIST_CONTACT, 'phonePrefixCountryCode', specialistContact.create.phonePrefixCountryCode)
	...
	it('Update specialist contact', () => {
		...
		cy.visit('/specialist-contacts')
		cy.clickButton(FORM.SPECIALIST_CONTACT, CREATE_BUTTON_ID)
		cy.setInputValue(FORM.SPECIALIST_CONTACT, 'countryCode', specialistContact.update.countryCode)
		cy.setInputValue(FORM.SPECIALIST_CONTACT, 'phonePrefixCountryCode', specialistContact.update.phonePrefixCountryCode)
