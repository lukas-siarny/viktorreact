...
type Props = {
	oldValue: string | string[] | undefined | null
	...
	if (images && typeof images === 'object') {
		return (
			<div className={'flex items-center justify-center'}>
				{images.map((image) => (
					<Image className={'ml-1 mr-1'} width={35} src={image} fallback={fallBackImg} />
				))}
			</div>
		)
	}
	return <Image width={35} src={images} fallback={fallBackImg} />
}
