...
import { ISearchable, ISearchableWithoutPagination, ISelectOptionItem } from '../types/interfaces'
...
// types
import { ISearchableParams } from '../schemas/queryParams'

const getSearchFn = (type: FILTER_ENTITY): ((params: ISearchableParams, disabled?: boolean) => ThunkResult<Promise<ISearchable<any> | ISearchableWithoutPagination<any>>>) => {
	switch (type) {
