...
import { Button, Col, Collapse, Divider, Form, Row, Space, Tag } from 'antd'
...
import { CALENDAR_EVENT_MANAGEMENT_SIDER_VIEW, FILTER_ENTITY, FORM, NOTIFICATION_TYPE, PARAMETER_TYPE, SALON_PERMISSION, STRINGS } from '../../../../utils/enums'
