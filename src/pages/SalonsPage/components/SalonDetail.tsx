...
import SalonForm from './forms/SalonForm'
...
import SalonApprovalModal from './modals/SalonApprovalModal'
import NotinoUserForm from './forms/NotinoUserForm'
...
import { getSalonDataForSubmission, initSalonFormData } from './salonUtils'
...
const SalonDetail: FC<SalonDetailProps> = (props) => {
	const [t] = useTranslation()
	const dispatch = useDispatch()
	const navigate = useNavigate()
	const { salonID, isNotinoUser, backUrl, phonePrefixes, authUser, phonePrefixCountryCode, salon, isDeletedSalon } = props
...
export default compose(withPermissions(permissions))(SalonDetail)
