...
export enum CALENDAR_DATE_FORMAT {
	...
	DAY = 'ddd, D MMM YYYY',
	WEEK_START = 'D - ',
	WEEK_END = 'D MMMM YYYY',
	MONTH = 'MMMM YYYY',
	// prelom rokov - tyzden
	WEEK_START_TURN_OF_THE_YEAR = 'D MMM - ',
	WEEK_END_TURN_OF_THE_YEAR = 'D MMM YYYY',
	// prelom rokov - mesiac
	MONTH_START_TURN_OF_THE_YEAR = 'MMM YYYY - ',
	MONTH_END_TURN_OF_THE_YEAR = 'MMM YYYY'
}
