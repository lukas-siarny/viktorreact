...
// NOTE: this is officials types from https://github.com/reduxjs/redux-thunk/blob/master/src/index.d.ts but not published yet on npm
import {
	Action,
...
export interface ThunkDispatch<TState, TExtraThunkArg, TBasicAction extends Action> {
	...
	<TReturnType, TAction extends TBasicAction>(action: TAction | ThunkAction<TReturnType, TState, TExtraThunkArg, TBasicAction>): TAction | TReturnType
}
 ...
 */
export type ThunkMiddleware<TState = {}, TBasicAction extends Action = AnyAction, TExtraThunkArg = undefined> = Middleware<
...
declare module 'redux' {
	...
	function bindActionCreators<TActionCreators extends ActionCreatorsMapObject<any>>(
		...
		[TActionCreatorName in keyof TActionCreators]: ReturnType<TActionCreators[TActionCreatorName]> extends ThunkAction<any, any, any, any>
